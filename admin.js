...
if (!majors.length) {
  const DEFAULT_MAJORS = [
    'باطنية','جراحة عامة','أطفال','نساء وولادة','عظام','جلدية','أسنان','قلب',
    'مخ وأعصاب','صدرية','جهاز هضمي','كلى','أنف وأذن وحنجرة','عيون','مسالك بولية',
    'أورام','أشعة','طوارئ','تخدير','علاج طبيعي','تحاليل طبية','تغذية علاجية','طب الأسرة'
  ];
